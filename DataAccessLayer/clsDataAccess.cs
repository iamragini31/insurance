...
namespace DataAccessLayer
{
    ...
    {
        private static string strConnection = ConfigurationSettings.AppSettings["ConnectionTouristInsured"].ToString();
        ...
        public static int ExecuteNonQueryTypedParams(String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return clsDataAccess.ExecuteNonQuery(CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return clsDataAccess.ExecuteNonQuery(CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static int ExecuteNonQueryTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return clsDataAccess.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return clsDataAccess.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static int ExecuteNonQueryTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return clsDataAccess.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return clsDataAccess.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
        ...
        public static DataSet ExecuteDatasetTypedParams(String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return clsDataAccess.ExecuteDataset(CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return clsDataAccess.ExecuteDataset(CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static DataSet ExecuteDatasetTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return clsDataAccess.ExecuteDataset(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return clsDataAccess.ExecuteDataset(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static DataSet ExecuteDatasetTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return clsDataAccess.ExecuteDataset(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return clsDataAccess.ExecuteDataset(transaction, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static SqlDataReader ExecuteReaderTypedParams(String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return clsDataAccess.ExecuteReader(CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return clsDataAccess.ExecuteReader(CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static SqlDataReader ExecuteReaderTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return clsDataAccess.ExecuteReader(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return clsDataAccess.ExecuteReader(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static SqlDataReader ExecuteReaderTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return clsDataAccess.ExecuteReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return clsDataAccess.ExecuteReader(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
        ...
        public static object ExecuteScalarTypedParams(String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return clsDataAccess.ExecuteScalar(CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return clsDataAccess.ExecuteScalar(CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static object ExecuteScalarTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return clsDataAccess.ExecuteScalar(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return clsDataAccess.ExecuteScalar(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static object ExecuteScalarTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return clsDataAccess.ExecuteScalar(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return clsDataAccess.ExecuteScalar(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
        ...
        public static XmlReader ExecuteXmlReaderTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return clsDataAccess.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return clsDataAccess.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static XmlReader ExecuteXmlReaderTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return clsDataAccess.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return clsDataAccess.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion

        #region public SqlDataReader RunSQLReturnDR(ref SqlConnection tempCnn, ref SqlTransaction tempSqlT, string strSQL)
        public static SqlDataReader RunSQLReturnDR(ref SqlConnection tempCnn, ref SqlTransaction tempSqlT, string strSQL)
        {
            SqlCommand cmd = new SqlCommand(strSQL, tempCnn);
            SqlDataReader rdr;
            cmd.Transaction = tempSqlT;
            try
            {
    ...
    public sealed class SqlHelperParameterCache
    {
        ...
        public static void CacheParameterSet(string commandText, params SqlParameter[] commandParameters)
        {
            ...
            string hashKey = strConnection + ":" + commandText;
