...
function mobGetAllList() {
    ...
    var isocode = $("#mobhdnisocode").val();
    var Touristisocode = $("#mobhdnTouristIsocode").val();
    var ddlVisaType = $("#mobddlVisaType").find("option:selected").val();
    ...
    if (isocode == "") {
        ...
        $.ajax({
            url: "/JVISAQuotation/GetAllQuationList/",
            type: "POST",
            contentType: false,
            processData: false,
            //dataType: "json",
            ...
            success: function (Res) {
                ...
                $("#mobddlVisaType").removeClass("enabled").addClass("disabled2");
