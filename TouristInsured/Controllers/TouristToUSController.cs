...
{
    public class TouristToUSController : Controller
    {
        // GET: TouristToUS
        ...
        public ActionResult TouristToUS()
        {
        ...
        [HttpPost]
        public ActionResult TouristToUS(LoginModel Loginmodel)
        {
            //return View();
            return RedirectToAction("TouristToUSQuotation", "TouristToUSQuotation", Loginmodel);
        }
