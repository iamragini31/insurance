...
namespace TouristInsured.Controllers
{
    public class QuotationController : Controller
    {
        ...
        // GET: Quotation
        public ActionResult Quotation(string Data)
        {
        ...
        public ActionResult GetQuotationAllList(QuotationModel req)
        {
            ...
            var Res = new { INsuranceComp, Result2, DistinctQuot, DistinctQuotNo, DistinctQuotYes, INFGroupNo, INFGroupYes, AtlasGroup, PLANTYPE, ComprehensivePlan , LimitedPlan , Result3, DistinctQuot2, DistinctQuotNo2, Result5, taborderbyasc , taborderbydes, PreExisting, PreExistingNo,
                Comprehensivebyasc, Comprehensivebydes,
                ComprehensivebyascPreexistingYES,ComprehensivebydesPreexistingYES,ComprehensivebyascPreexistingNO,
                ComprehensivebydesPreexistingNO,LimitedPreExistingYEs,LimitedPreExistingNo,LimitedByDes,
                LimitedByAsc,ComprehensivePreExistingYes,ComprehensivePreExistingNo,PreexistingByLimitedByAsc,PreexistingByLimitedbydes,
                PreExistingNoByDes,PreExistingNoByAcs,PreExistingYesByDes,PreExistingYesByAcs,PreexistingNoByLimitedByAsc,PreexistingNoByLimitedbydes
            };
...
,
        ...
        //    destinationUrl = "http://azimuthrisk.dev.radixweb.net/rest_server_beacon.php";
