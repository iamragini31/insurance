...
{
    public class InternationStudentToUSAQuotationController : Controller
    {
        ...
        // GET: InternationStudentToUSAQuotation
        public ActionResult InternationStudentToUSAQuotation(string Data)
        {
            ...
            Quotationmodel.JVISA = Quotes.Rows[0]["VisaType"].ToString();
        ...
        public ActionResult GetQuotationAllList(QuotationModel req)
        {
            ...
            string StudentSecure = ConfigurationManager.AppSettings["StudentSecure"];
            ...
            else
            {
                    ...
                    else
                    {
                        if (IMGstatus == "1")
                        {
                            ...
                            if (req.TouristISOCODE == "US")
                            {
                                ...
                                string[] productCode = { "EPSNI", "SHAA", "SHAPA" };
                                for (int i = 0; i < productCode.Length; i++)
                                {

                                    if (productCode[i] == "EPSNI")
                                    {
                                        string apptype = "0619";
                    ...
                    else
                    {
                        ...
                        if (StudentSecure == "1")
                        {
                            ...
                            if (age <= 65)
                            {
                                ...
                                string[] AppName = { "Elite", "Budget", "Select", "Smart" };
                                for (int i = 0; i < AppName.Length; i++)
                                {
                                    if (AppName[i] == "Elite")
                                    {
                                        string[] policymax = { "500000" };
                                        string[] deductible = { "25" };
                                        for (int k = 0; k < policymax.Length; k++)
                                        {
                                            if (policymax[k] == "500000")
                                            {
                                                for (int j = 0; j < deductible.Length; j++)
                                                {
                                                    if (deductible[j] == "25")
                                    ...
                                    else if (AppName[i] == "Budget")
                                    {
                                        string[] policymax = { "250000" };
                                        string[] deductible = { "45" };
                                        for (int k = 0; k < policymax.Length; k++)
                                        {
                                            if (policymax[k] == "250000")
                                            {
                                                for (int j = 0; j < deductible.Length; j++)
                                                {
                                                    if (deductible[j] == "45")
                                    ...
                                    else if (AppName[i] == "Select")
                                    {
                                        string[] policymax = { "300000" };
                                        string[] deductible = { "35" };
                                        for (int k = 0; k < policymax.Length; k++)
                                        {
                                            if (policymax[k] == "300000")
                                            {
                                                for (int j = 0; j < deductible.Length; j++)
                                                {
                                                    if (deductible[j] == "35")
                                    ...
                                    else if (AppName[i] == "Smart")
                                    {
                                        string[] policymax = { "200000 " };
                                        string[] deductible = { "50" };
                                        for (int k = 0; k < policymax.Length; k++)
                                        {
                                            if (policymax[k] == "200000 ")
                                            {
                                                for (int j = 0; j < deductible.Length; j++)
                                                {
                                                    if (deductible[j] == "50")
                    ...
                    if (req.ISOCODE != "US" && req.TouristISOCODE == "US")
                    {
                            if (age >= 12 && age <= 40)
                            {
                                ...
                                for (int i = 0; i < length; i++)
                                {
                                    if (array[i] == 127)
                                    {
                                        ...
                                        {
                                            trawickstudent(req, array[i], plan[j]);
                                        }

                                    }
                                    else if (array[i] == 129)
                                    {
                                        int[] plan = { 1690, 1693, 1694 };
                                        for (int j = 0; j < plan.Length; j++)
                                        {
                                            trawickstudent(req, array[i], plan[j]);
                                        }
                            ...
                            if (age <= 64)
                            {
                                ...
                                for (int i = 0; i < length; i++)
                                {
                                    if (array[i] == 124)
                                    {
                                        trawickstudent(req, array[i], 1686);
                                    }
                                    else {
                                        trawickstudent(req, array[i], 1687);
                                    }
                                }
                            }
                ...
                if(DATE >= 30)
                {
                    ...
                    string[] plantype = { "Student Only", "Student & Spouse", "Student & Child(ren)", "Student & Family" };
                    for(int i = 0; i < plantype.Length; i++)
                    {
                        if(plantype[i] == "Student Only")
                        {
                            string[] planname = { "BASIC", "STANDARD", "PREFERRED 300", "PREFERRED 500" };
                            for(int j = 0; j < planname.Length; j++)
                            {
                                var Studtusa = SearchStudyusa(req, DATE, age,plantype[i],planname[j]);
                            }
                        }
                        else if (plantype[i] == "Student & Spouse")
                        {
                            string[] planname = {  "STANDARD", "PREFERRED 300", "PREFERRED 500"};
                            for (int j = 0; j < planname.Length; j++)
                            {
                                var Studtusa = SearchStudyusa(req, DATE, age, plantype[i], planname[j]);
                            }
                        }
                        else if (plantype[i] == "Student & Child(ren)")
                        {
                            string[] planname = { "STANDARD", "PREFERRED 300", "PREFERRED 500" };
                            for (int j = 0; j < planname.Length; j++)
                            {
                        ...
                        else if (plantype[i] == "Student & Family")
                        {
                            string[] planname = { "STANDARD", "PREFERRED 300", "PREFERRED 500" };
                            for (int j = 0; j < planname.Length; j++)
                            {
        ...
        public ActionResult GetAllQuationList(FormCollection form)
        {
            ...
            req.JVISA = form["txttouristountry"];
        ...
        public Models.RootObject Index(QuotationModel req)
        {
            long ID = 0;
            long policy_max = 0; //req.policy_max;
            long deductible = 0; // req.deductible;
            if (req.ISOCODE != "US" && req.TouristISOCODE != "US")
            {
                ID = 19;
                policy_max = 50000;
            ...
            //string eff_date = Convert.ToDateTime(req.LeavingHome).ToString("MM-dd-yyyy");// req.LeavingHome;
            //string term_date = Convert.ToDateTime(req.TillDate).ToString("MM-dd-yyyy");// req.TillDate;
            string eff_date = req.LeavingHome;
            string term_date = req.TillDate;

            string country = req.ISOCODE;
            string destination = req.TouristISOCODE;
            string dob1 = DOBFun(Convert.ToInt32(req.name));

            string URL = "https://API2017.trawickinternational.com/API2016.asmx/ProcessRequest";
            string postData = "product="
                                        + ID + "&eff_date="
                                        + eff_date + "&term_date="
                                        + term_date + "&country="
                                        + country + "&destination="
                                        + destination + "&policy_max="
                                        + policy_max + "&deductible="
                                        + deductible + "&dob1="
                                        + dob1 + "&agent_id=1";
            ...
            Models.RootObject finalResult = jsSerializer.Deserialize<Models.RootObject>(result);

            AllQuatationResult AllQuatationresult = new AllQuatationResult();
            AllQuatationresult.PlanId = finalResult.ProductId;
            AllQuatationresult.policyName = "Safe Travel";
            AllQuatationresult.planMaximum = 50000;
            AllQuatationresult.planDeductible = 50;
            AllQuatationresult.preExDeductible = 0.0;
            AllQuatationresult.preExCoverageAmount = 0.0;
            AllQuatationresult.totalPremium = (finalResult.TotalPrice);
            AllQuatationresult.INsuranceComp = "Trawick";
            AllQuatationresult.BuyNowLink = finalResult.BuyNowLink;
        ...
        public List<Models.TrawickStudentResponnse> trawick_purchase(QuotationModel req, int ID)
        {
            List<Models.TrawickStudentResponnse> finalResult = new List<Models.TrawickStudentResponnse>();
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                return new List<Models.TrawickStudentResponnse>();
            }
        }
        public int trawickstudent(QuotationModel req, int ID,int plan)
        {
            
                string LeavingHome = req.LeavingHome;
                string TillDate = req.TillDate;
                string ISOCODE = req.ISOCODE;
                string TouristISOCODE = req.TouristISOCODE;
                ...
                if (req.travelersage != 0)
                {
                    ...
                    TravelersDOB = getmonth + "/" + getdate + "/" + getDOByear.ToString();
                }
                if (req.spouseage != "")
                {
                    ...
                    string getdate = DateTime.Now.Day.ToString();
                    string getmonth = DateTime.Now.Month.ToString();
                    SpouseDOB = getmonth + "/" + getdate + "/" + getDOByear.ToString();
                }
                if (req.child1age != "")
                {
                    ...
                    string getdate = DateTime.Now.Day.ToString();
                    string getmonth = DateTime.Now.Month.ToString();
                    Child1DOB = getmonth + "/" + getdate + "/" + getDOByear.ToString();
                }
                if (req.child2age != "")
                {
                    ...
                    string getdate = DateTime.Now.Day.ToString();
                    string getmonth = DateTime.Now.Month.ToString();
                    Child2DOB = getmonth + "/" + getdate + "/" + getDOByear.ToString();
                }
                if (req.child3age != "")
                {
                    ...
                    string getdate = DateTime.Now.Day.ToString();
                    string getmonth = DateTime.Now.Month.ToString();
                    Child3DOB = getmonth + "/" + getdate + "/" + getDOByear.ToString();
                }
                if (req.child4age != "")
                {
                    ...
                    string getdate = DateTime.Now.Day.ToString();
                    string getmonth = DateTime.Now.Month.ToString();
                    Child4DOB = getmonth + "/" + getdate + "/" + getDOByear.ToString();
                }
                if (req.spouseage != "" && req.child1age == "" && req.child2age == "" && req.child3age == "" && req.child4age == "")
                {
                    postData = "product=" + ID + "&eff_date=" + LeavingHome + "&term_date=" + TillDate + "&country=" + ISOCODE + "&destination=" + TouristISOCODE +
     "&dob1=" + TravelersDOB + "&spousedob=" + SpouseDOB + "&agent_id=" + 1 + "&Plan=" +plan ;
                }
                else if (req.spouseage != "" && req.child1age != "" && req.child2age == "" && req.child3age == "" && req.child4age == "")
                {
                    postData = "product=" + ID + "&eff_date=" + LeavingHome + "&term_date=" + TillDate + "&country=" + ISOCODE + "&destination=" + TouristISOCODE +
     "&dob1=" + TravelersDOB + "&spousedob=" + SpouseDOB + "&Child1dob=" + Child1DOB + "&agent_id=" + 1 + "&Plan=" + plan;
            }
                else if (req.spouseage != "" && req.child1age != "" && req.child2age != "" && req.child3age == "" && req.child4age == "")
                {
                    postData = "product=" + ID + "&eff_date=" + LeavingHome + "&term_date=" + TillDate + "&country=" + ISOCODE + "&destination=" + TouristISOCODE +
     "&dob1=" + TravelersDOB + "&spousedob=" + SpouseDOB + "&Child1dob=" + Child1DOB + "&Child2dob=" + Child2DOB + "&agent_id=" + 1 + "&Plan=" + plan;
            }
                else if (req.spouseage != "" && req.child1age != "" && req.child2age != "" && req.child3age != "" && req.child4age == "")
                {
                    postData = "product=" + ID + "&eff_date=" + LeavingHome + "&term_date=" + TillDate + "&country=" + ISOCODE + "&destination=" + TouristISOCODE +
     "&dob1=" + TravelersDOB + "&spousedob=" + SpouseDOB + "&Child1dob=" + Child1DOB + "&Child2dob=" + Child2DOB + "&Child3dob=" + Child3DOB + "&agent_id=" + 1 + "&Plan=" + plan;
            }
                else if (req.spouseage != "" && req.child1age != "" && req.child2age != "" && req.child3age != "" && req.child4age != "")
                {
                    postData = "product=" + ID + "&eff_date=" + LeavingHome + "&term_date=" + TillDate + "&country=" + ISOCODE + "&destination=" + TouristISOCODE +
     "&dob1=" + TravelersDOB + "&spousedob=" + SpouseDOB + "&Child1dob=" + Child1DOB + "&Child2dob=" + Child2DOB + "&Child3dob=" + Child3DOB + "&Child4dob=" + Child4DOB + "&agent_id=" + 1 + "&Plan=" + plan;
            }

                else if (req.spouseage == "" && req.child1age != "" && req.child2age == "" && req.child3age == "" && req.child4age == "")
                {
                    postData = "product=" + ID + "&eff_date=" + LeavingHome + "&term_date=" + TillDate + "&country=" + ISOCODE + "&destination=" + TouristISOCODE +
     "&dob1=" + TravelersDOB + "&Child1dob=" + Child1DOB + "&agent_id=" + 1 + "&Plan=" + plan;
            }
                else if (req.spouseage == "" && req.child1age != "" && req.child2age != "" && req.child3age == "" && req.child4age == "")
                {
                    postData = "product=" + ID + "&eff_date=" + LeavingHome + "&term_date=" + TillDate + "&country=" + ISOCODE + "&destination=" + TouristISOCODE +
     "&dob1=" + TravelersDOB + "&Child1dob=" + Child1DOB + "&Child2dob=" + Child2DOB + "&agent_id=" + 1 + "&Plan=" + plan;
            }
                else if (req.spouseage == "" && req.child1age != "" && req.child2age != "" && req.child3age != "" && req.child4age == "")
                {
                    postData = "product=" + ID + "&eff_date=" + LeavingHome + "&term_date=" + TillDate + "&country=" + ISOCODE + "&destination=" + TouristISOCODE +
     "&dob1=" + TravelersDOB + "&Child1dob=" + Child1DOB + "&Child2dob=" + Child2DOB + "&Child3dob=" + Child3DOB + "&agent_id=" + 1 + "&Plan=" + plan;
            }
                else if (req.spouseage == "" && req.child1age != "" && req.child2age != "" && req.child3age != "" && req.child4age != "")
                {
                    postData = "product=" + ID + "&eff_date=" + LeavingHome + "&term_date=" + TillDate + "&country=" + ISOCODE + "&destination=" + TouristISOCODE +
     "&dob1=" + TravelersDOB + "&Child1dob=" + Child1DOB + "&Child2dob=" + Child2DOB + "&Child3dob=" + Child3DOB + "&Child4dob=" + Child4DOB + "&agent_id=" + 1 + "&Plan=" + plan;
            }
                else
                {
                    postData = "product=" + ID + "&eff_date=" + LeavingHome + "&term_date=" + TillDate + "&country=" + ISOCODE + "&destination=" + TouristISOCODE +
 "&dob1=" + TravelersDOB + "&agent_id=" + 1 + "&Plan=" + plan;
            }
                HttpWebRequest request = (HttpWebRequest)WebRequest.Create(URL);
                request.Method = "POST";
                request.ContentLength = postData.Length;
                ...
                List<Models.checkresult> finalResult4 = jsSerializer.Deserialize<List<Models.checkresult>>(result);

                var Response = new JavaScriptSerializer().Deserialize<Models.TrawickSchengen>(result);
                DateTime LeavingHome1 = DateTime.Parse(req.LeavingHome);
                DateTime TillDate1 = DateTime.Parse(req.TillDate);

                var DATE = (TillDate1 - LeavingHome1).TotalDays;
                DATE = DATE + 1;
            ...
            if (plan == 1686)
            {
                planname = "COLLEGIATE CARE ESSENTIAL ";
                appname = "CCE";
                DEDUC = 0;
                MAX = 0;
            }
            if (plan == 1687)
            {
                planname = "COLLEGIATE CARE ENHANCED ";
                appname = "CCEH";
                DEDUC = 0;
                MAX = 0;
            }
            if (plan == 1689)
            {
                planname = "COLLEGIATE CARE ELITE ";
                appname = "CCEL";
                DEDUC =100;
                MAX = 0;
            }
            ...
            if (plan == 1690)
            {
                planname = "COLLEGIATE CARE EXCLUSIVE ";
                appname = "CCEX";
                DEDUC = 100;
                MAX = 0;
            }
            ...
            List<QuotationModel> listitem = quotationalmanager.GetPlanDetails(appname);
                double premiumamount = Response.TotalPrice;
                ...
                AllQuatationresult.planMaximum = Convert.ToDouble(MAX);
                AllQuatationresult.planDeductible = Convert.ToDouble(DEDUC);
                AllQuatationresult.preExDeductible = 0.0;
                AllQuatationresult.preExCoverageAmount = 0.0;
                ...
                AllQuatationresult.UW_Name = listitem[0].UW_Name;
                        ...
                        if ((quote.spouseage == "") && (quote.child1age == "" && quote.child2age == "") && (quote.child3age == "" && quote.child4age == ""))
                        {
                            ...
                            foreach (Models.INF_Quote item in finalResult)
                            {
                                ...
                                if (item.policyName == "INF STANDARD" || item.policyName == "INF TRAVELUSA" || item.policyName == "INF ELITE" || item.policyName == "INF PREMIER")
                                {
                                    ...
                                    var totalpremium = item.totalPremium + 15.00;
                                    var premium = Math.Floor(totalpremium * 100) / 100;
                                    AllQuatationResult AllQuatationresult = new AllQuatationResult();
        ...
        public int SearchIMG(string productCode, int deductible, int maximumlimit, QuotationModel req, string apptype, string AuthKey)
        {
            ...
            try
            {
                ...
                else if (productCode == "SHAA")
                {

                    Productname = "STUDENT HEALTH ADVANTAGE AMERICA";
                }
                else if (productCode == "SHAPA")
                {

                    Productname = "STUDENT HEALTH ADVANTAGE PLATINUM AMERICA";
                }
                ...
                var premium = Math.Floor(myDetails.TotalPremium * 100) / 100;
                AllQuatationResult AllQuatationresult = new AllQuatationResult();
        ...
        public void GetDummyIMGValue(string productCode, int deductible, int maximumlimit, QuotationModel req, string apptype)
        {
            ...
            else if (productCode == "SHAA" || productCode == "SHAI")
            {
                ...
                {
                    Productname = "STUDENT HEALTH ADVANTAGE INTERNATIONAL";
                }
            }
            else if (productCode == "SHAPA" || productCode == "SHAPI")
            {
                if (productCode == "SHAPA")
                {
                    Productname = "STUDENT HEALTH ADVANTAGE PLATINUM AMERICA";
                }
                else
                {
                    Productname = "STUDENT HEALTH ADVANTAGE PLATINUM INTERNATIONAL";
                }
        ...
        public int SearchStudyusa(QuotationModel req, double DATE, int age, string plantype, string planname)
        {
            if (req.spouseage == null)
            {
                req.spouseage = "";
            ...
            if (planname == "PREFERRED 300")
            {
                planmax = 300000;
                productCode = "SUHP3"; 
            }
            if (planname == "PREFERRED 500")
            {
                planmax = 500000;
                productCode = "SUHP5";
            }
            if ((req.spouseage == "") && (req.child1age == "") && (req.child2age == "") && (req.child3age == "") && (req.child4age == ""))
            {
                if (plantype == "Student Only")
                {
                    ...
                    if (planname == "BASIC")
                    {
                        ...
                        if (age < 25)
                        {
                            totalpremium = 1.03 * DATE;
                        }
                        else if (age >= 25 && age <= 29)
                        {
                            totalpremium = 1.99 * DATE;
                        }
                        else if (age >= 30 && age <= 34)
                        {
                            totalpremium = 3.00 * DATE;
                        }
                        else if (age >= 35 && age <= 39)
                        {
                            totalpremium = 4.48 * DATE;
                        }
                        else if (age >= 40 && age <= 44)
                        {
                            totalpremium = 5.21 * DATE;
                        }
                        else if (age >= 45 && age <= 49)
                        {
                            totalpremium = 5.34 * DATE;
                        }
                        else if (age >= 50 && age <= 54)
                        {
                            totalpremium = 10.15 * DATE;
                        }
                        else if (age >= 55 && age <= 65)
                        {
                            totalpremium = 10.41 * DATE;
                        }
                        planmax = 200000;
                        deductibe = 0;
                    ...
                    else if (planname == "STANDARD")
                    {
                        ...
                        if (age < 25)
                        {
                            totalpremium = 1.36 * DATE;
                        }
                        else if (age >= 25 && age <= 29)
                        {
                            totalpremium = 2.57 * DATE;
                        }
                        else if (age >= 30 && age <= 34)
                        {
                            totalpremium = 3.49 * DATE;
                        }
                        else if (age >= 35 && age <= 39)
                        {
                            totalpremium = 4.94 * DATE;
                        }
                        else if (age >= 40 && age <= 44)
                        {
                            totalpremium = 6.21 * DATE;
                        }
                        else if (age >= 45 && age <= 49)
                        {
                            totalpremium = 6.48 * DATE;
                        }
                        else if (age >= 50 && age <= 54)
                        {
                            totalpremium = 12.12 * DATE;
                        }
                        else if (age >= 55 && age <= 65)
                        {
                            totalpremium = 14.59 * DATE;
                        }
                       
                    }
                    else if (planname == "PREFERRED 300")
                    {


                        if (age < 25)
                        {
                            totalpremium = 2.18 * DATE;
                        }
                        else if (age >= 25 && age <= 29)
                        {
                            totalpremium = 3.18 * DATE;
                        }
                        else if (age >= 30 && age <= 34)
                        {
                            totalpremium = 4.03 * DATE;
                        }
                        else if (age >= 35 && age <= 39)
                        {
                            totalpremium = 5.70 * DATE;
                        }
                        else if (age >= 40 && age <= 44)
                        {
                            totalpremium = 7.17 * DATE;
                        }
                        else if (age >= 45 && age <= 49)
                        {
                            totalpremium = 7.77 * DATE;
                        }
                        else if (age >= 50 && age <= 54)
                        {
                            totalpremium = 14.35 * DATE;
                        }
                        else if (age >= 55 && age <= 65)
                        {
                            totalpremium = 17.20 * DATE;
                        }
                        productCode = "SUHP3";
                    }
                    else if (planname == "PREFERRED 500")
                    {


                        if (age < 25)
                        {
                            totalpremium = 2.48 * DATE;
                        }
                        else if (age >= 25 && age <= 29)
                        {
                            totalpremium = 3.62 * DATE;
                        }
                        else if (age >= 30 && age <= 34)
                        {
                            totalpremium = 4.59 * DATE;
                        }
                        else if (age >= 35 && age <= 39)
                        {
                            totalpremium = 6.48 * DATE;
                        ...
                        {
                            totalpremium = 8.18 * DATE;
                        }
                        else if (age >= 45 && age <= 49)
                        {
                            totalpremium = 8.85 * DATE;
                        }
                        else if (age >= 50 && age <= 54)
                        {
                            totalpremium = 16.34 * DATE;
                        }
                        else if (age >= 55 && age <= 65)
                        {
                            totalpremium = 19.59 * DATE;
                        }
                        productCode = "SUHP5";
                    }
                    ...
                    AllQuatationResult AllQuatationresult = new AllQuatationResult();
                    AllQuatationresult.PlanId = 1;
                    AllQuatationresult.policyName = "STUDY USA-HEALTHCARE-" + planname;
                    AllQuatationresult.planDeductible = deductibe;
                    AllQuatationresult.preExDeductible = 0.0;
                    AllQuatationresult.preExCoverageAmount = 0.0;
                    AllQuatationresult.totalPremium = premium + 5;
                    AllQuatationresult.planMaximum = planmax ;
                    AllQuatationresult.INsuranceComp = "IMG";
                    AllQuatationresult.BuyNowLink = "";
                    AllQuatationresult.policyType = "";
                    AllQuatationresult.prexded = "N";
            ...
            else if ((req.spouseage != "") && (req.child1age != "") && (req.child2age == "") && (req.child3age == "") && (req.child4age == ""))
            {
                if (plantype == "Student & Family")
                {
                    if (planname == "STANDARD")
                    {
                        ...
                        if (age < 25)
                        {
                            totalpremium = 21.05 * DATE;
                        }
                        else if (age >= 25 && age <= 29)
                        {
                            totalpremium = 24.80 * DATE;
                        }
                        else if (age >= 30 && age <= 34)
                        {
                            totalpremium = 27.13 * DATE;
                        }
                        else if (age >= 35 && age <= 39)
                        {
                            totalpremium = 33.19 * DATE;
                        }
                        else if (age >= 40 && age <= 44)
                        {
                            totalpremium = 37.85 * DATE;
                        }
                        else if (age >= 45 && age <= 49)
                        {
                            totalpremium = 39.70 * DATE;
                        }
                        else if (age >= 50 && age <= 54)
                        {
                            totalpremium = 44.46 * DATE;
                        }
                        else if (age >= 55 && age <= 65)
                        {
                            totalpremium = 59.96 * DATE;
                            productCode = "SUHB";
                        }
                    }
                    else if (planname == "PREFERRED 300")
                    {
                        ...
                        if (age < 25)
                        {
                            totalpremium = 22.27 * DATE;
                        }
                        else if (age >= 25 && age <= 29)
                        {
                            totalpremium = 26.24 * DATE;
                        }
                        else if (age >= 30 && age <= 34)
                        {
                            totalpremium = 33.95 * DATE;
                        }
                        else if (age >= 35 && age <= 39)
                        {
                            totalpremium = 43.91 * DATE;
                        }
                        else if (age >= 40 && age <= 44)
                        {
                            totalpremium = 48.13 * DATE;
                        }
                        else if (age >= 45 && age <= 49)
                        {
                            totalpremium = 52.77 * DATE;
                        }
                        else if (age >= 50 && age <= 54)
                        {
                            totalpremium = 57.84 * DATE;
                        }
                        else if (age >= 55 && age <= 65)
                        {
                            totalpremium = 63.43 * DATE;
                        }
                        productCode = "SUHP3";
                    }
                    else if (planname == "PREFERRED 500")
                    {
                        ...
                        if (age < 25)
                        {
                            totalpremium = 25.36 * DATE;
                        }
                        else if (age >= 25 && age <= 29)
                        {
                            totalpremium = 29.88 * DATE;
                        }
                        else if (age >= 30 && age <= 34)
                        {
                            totalpremium = 38.67 * DATE;
                        }
                        else if (age >= 35 && age <= 39)
                        {
                            totalpremium = 50.03 * DATE;
                        }
                        else if (age >= 40 && age <= 44)
                        {
                            totalpremium = 54.83 * DATE;
                        }
                        else if (age >= 45 && age <= 49)
                        {
                            totalpremium = 60.10 * DATE;
                        }
                        else if (age >= 50 && age <= 54)
                        {
                            totalpremium = 65.90 * DATE;
                        }
                        else if (age >= 55 && age <= 65)
                        {
                            totalpremium = 72.24 * DATE;
                        }
                        productCode = "SUHP5";
                    }
                    ...
                    AllQuatationresult.PlanId = 1;
                    AllQuatationresult.policyName = "STUDY USA-HEALTHCARE-" + planname;
                    AllQuatationresult.planDeductible = 0;
                    AllQuatationresult.preExDeductible = 0.0;
                    AllQuatationresult.preExCoverageAmount = 0.0;
                    AllQuatationresult.totalPremium = premium + 5;
                    AllQuatationresult.planMaximum = 0;
                    AllQuatationresult.INsuranceComp = "IMG";
                    AllQuatationresult.BuyNowLink = "";
                    AllQuatationresult.policyType = "";
                    AllQuatationresult.prexded = "N";
            ...
            else if ((req.spouseage == "") && (req.child1age != "") && (req.child2age == "") && (req.child3age == "") && (req.child4age == ""))
            {
                if (plantype == "Student & Child(ren)")
                {
                    if (planname == "STANDARD")
                    {
                        ...
                        if (age < 25)
                        {
                            totalpremium = 9.04 * DATE;
                        }
                        else if (age >= 25 && age <= 29)
                        {
                            totalpremium = 9.79 * DATE;
                        }
                        else if (age >= 30 && age <= 34)
                        {
                            totalpremium = 10.37 * DATE;
                        }
                        else if (age >= 35 && age <= 39)
                        {
                            totalpremium = 11.15 * DATE;
                        }
                        else if (age >= 40 && age <= 44)
                        {
                            totalpremium = 12.30 * DATE;
                        }
                        else if (age >= 45 && age <= 49)
                        {
                            totalpremium = 15.75 * DATE;
                        }
                        else if (age >= 50 && age <= 54)
                        {
                            totalpremium = 22.31 * DATE;
                        }
                        else if (age >= 55 && age <= 65)
                        {
                            totalpremium = 32.58 * DATE;
                        }
                    }
                    else if (planname == "PREFERRED 300")
                    {
                        ...
                        if (age < 25)
                        {
                            totalpremium = 9.57 * DATE;
                        }
                        else if (age >= 25 && age <= 29)
                        {
                            totalpremium = 10.36 * DATE;
                        }
                        else if (age >= 30 && age <= 34)
                        {
                            totalpremium = 11.98 * DATE;
                        }
                        else if (age >= 35 && age <= 39)
                        {
                            totalpremium = 13.84 * DATE;
                        }
                        else if (age >= 40 && age <= 44)
                        {
                            totalpremium = 18.11 * DATE;
                        }
                        else if (age >= 45 && age <= 49)
                        {
                            totalpremium = 23.69 * DATE;
                        }
                        else if (age >= 50 && age <= 54)
                        {
                            totalpremium = 28.56 * DATE;
                        }
                        else if (age >= 55 && age <= 65)
                        {
                            totalpremium = 34.46 * DATE;
                        }
                    }
                    else if (planname == "PREFERRED 500")
                    {
                        ...
                        if (age < 25)
                        {
                            totalpremium = 10.90 * DATE;
                        }
                        else if (age >= 25 && age <= 29)
                        {
                            totalpremium = 11.79 * DATE;
                        }
                        else if (age >= 30 && age <= 34)
                        {
                            totalpremium = 13.64 * DATE;
                        }
                        else if (age >= 35 && age <= 39)
                        {
                            totalpremium = 15.75 * DATE;
                        ...
                        {
                            totalpremium = 20.62 * DATE;
                        }
                        else if (age >= 45 && age <= 49)
                        {
                            totalpremium = 26.98 * DATE;
                        }
                        else if (age >= 50 && age <= 54)
                        {
                            totalpremium = 32.53 * DATE;
                        }
                        else if (age >= 55 && age <= 65)
                        {
                            totalpremium = 39.24 * DATE;
                        }
                    }
            ...
            else if ((req.spouseage != "") && (req.child1age == "") && (req.child2age == "") && (req.child3age != "") && (req.child4age == ""))
            {
                if (plantype == "Student & Spouse")
                {
                    if (planname == "STANDARD")
                    {
                        ...
                        if (age < 25)
                        {
                            totalpremium = 14.32 * DATE;
                        }
                        else if (age >= 25 && age <= 29)
                        {
                            totalpremium = 17.93 * DATE;
                        }
                        else if (age >= 30 && age <= 34)
                        {
                            totalpremium = 20.74 * DATE;
                        }
                        else if (age >= 35 && age <= 39)
                        {
                            totalpremium = 27.86 * DATE;
                        }
                        else if (age >= 40 && age <= 44)
                        {
                            totalpremium = 30.57 * DATE;
                        }
                        else if (age >= 45 && age <= 49)
                        {
                            totalpremium = 32.77 * DATE;
                        }
                        else if (age >= 50 && age <= 54)
                        {
                            totalpremium = 41.41 * DATE;
                        }
                        else if (age >= 55 && age <= 65)
                        {
                            totalpremium = 54.37 * DATE;
                        }
                    }
                    else if (planname == "PREFERRED 300")
                    {
                        ...
                        if (age < 25)
                        {
                            totalpremium = 15.14 * DATE;
                        }
                        else if (age >= 25 && age <= 29)
                        {
                            totalpremium = 18.96 * DATE;
                        }
                        else if (age >= 30 && age <= 34)
                        {
                            totalpremium = 26.43 * DATE;
                        }
                        else if (age >= 35 && age <= 39)
                        {
                            totalpremium = 36.86 * DATE;
                        }
                        else if (age >= 40 && age <= 44)
                        {
                            totalpremium = 41.26 * DATE;
                        }
                        else if (age >= 45 && age <= 49)
                        {
                            totalpremium = 46.19 * DATE;
                        }
                        else if (age >= 50 && age <= 54)
                        {
                            totalpremium = 51.53 * DATE;
                        }
                        else if (age >= 55 && age <= 65)
                        {
                            totalpremium = 57.51 * DATE;
                        }
                    }
                    else if (planname == "PREFERRED 500")
                    {
                        ...
                        if (age < 25)
                        {
                            totalpremium = 17.26 * DATE;
                        }
                        else if (age >= 25 && age <= 29)
                        {
                            totalpremium = 21.59 * DATE;
                        }
                        else if (age >= 30 && age <= 34)
                        {
                            totalpremium = 30.12 * DATE;
                        }
                        else if (age >= 35 && age <= 39)
                        {
                            totalpremium = 41.98 * DATE;
                        }
                        else if (age >= 40 && age <= 44)
                        {
                            totalpremium = 46.99 * DATE;
                        }
                        else if (age >= 45 && age <= 49)
                        {
                            totalpremium = 52.59 * DATE;
                        }
                        else if (age >= 50 && age <= 54)
                        {
                            totalpremium = 58.70 * DATE;
                        }
                        else if (age >= 55 && age <= 65)
                        {
                            totalpremium = 65.50 * DATE;
                        }
                    }
        ...
        public string SearchHCCAtlas(string policymax, string deductible, string AppName, QuotationModel req, int age)
        {
            try
            {
                ...
                var Quote = new Models.hccStudentRequest();
                Quote.ReferId = "9800";
                Quote.Culture = "en-US";
                Quote.USDest = dest;
                ...
                Quote.PlanType = AppName;//"250000";//
                Quote.PaymentType = "F"; //"250";//
                


                Quote.MailOpt = "regular";
                Quote.SurlpusLines = false;
                ...
                var json = JsonConverter.Serialize(Quote);
                string AtlasGEtQuote = "http://beta.hccmis.com/IWebAPI/api/studentsecure/v1/quote";
                string Domainname = ConfigurationManager.AppSettings["Domainname"];
                ...
                if (req.TouristISOCODE == "US")
                {
                    if (AppName == "Elite")
                    {
                        Planname = "STUDENT SECURE ELITE";
                    }
                    else if (AppName == "Budget")
                    {
                        Planname = "STUDENT SECURE BUDGET";
                    }
                    else if (AppName == "Select")
                    {
                        Planname = "STUDENT SECURE SELECT";
                    }
                    else if (AppName == "Smart")
                    {
                        Planname = "STUDENT SECURE SMART";
                    }
                }
                else
                {
                ...
                List<QuotationModel> listitem = quotationalmanager.GetPlanDetails(AppName);
                string total = String.Format("{0:0.00}", finalResult.Total);
                var premium =Math.Floor( finalResult.Total * 100) / 100;
                premium = premium + 0.00;
                premium = Convert.ToDouble(total);
                AllQuatationResult AllQuatationresult = new AllQuatationResult();
                AllQuatationresult.PlanId = Convert.ToInt64(1);
                AllQuatationresult.policyName = Planname;
                AllQuatationresult.planDeductible = Convert.ToDouble(deductible);
...
,
        ...
        public ActionResult PremiumamountforIMG(FormCollection form)
        {
            ...
            else if (PolicyName == "STUDENT HEALTH ADVANTAGE AMERICA" || PolicyName == "STUDENT HEALTH ADVANTAGE INTERNATIONAL")
            {
                if (form["hdnTouristcode"] == "US")
                {
                    productCode = "SHAA ";
            ...
            else if (PolicyName == "STUDENT HEALTH ADVANTAGE PLATINUM AMERICA" || PolicyName == "STUDENT HEALTH ADVANTAGE PLATINUM INTERNATIONAL")
            {
                if (form["hdnTouristcode"] == "US")
                {
                    productCode = "SHAPA";
