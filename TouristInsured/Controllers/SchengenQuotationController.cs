...
{
    public class SchengenQuotationController : Controller
    {
        ...
        // GET: Quotation
        public ActionResult SchengenQuotation(string Data)
        {
        ...
        public void check()
        {
            var check = "{\"Name\":\"Ragini\",\"Marks\":25}";
            System.Web.Script.Serialization.JavaScriptSerializer jsSerializer = new System.Web.Script.Serialization.JavaScriptSerializer();

       
            List<Models.SchengenResponse> finalResult5 = new List<Models.SchengenResponse>();
            finalResult5 = jsSerializer.Deserialize<List<Models.SchengenResponse>>(check);
            var Response = new JavaScriptSerializer().Deserialize<Models.SchengenResponse>(check);
