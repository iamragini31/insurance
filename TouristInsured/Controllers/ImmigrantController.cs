...
{
    public class ImmigrantController : Controller
    {
        LoginModel Loginmodel = new LoginModel();
        LoginManager Loginmanager = new LoginManager();

        public ActionResult Immigrant()
        {
        ...
        [HttpPost]
        public ActionResult Immigrant(LoginModel Loginmodel)
        {
            //return View();
            return RedirectToAction("ImmigrantQuotation", "ImmigrantQuotation", Loginmodel);
        }
