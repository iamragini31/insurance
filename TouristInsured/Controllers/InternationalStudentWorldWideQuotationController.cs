...
{
    public class InternationalStudentWorldWideQuotationController : Controller
    {
        ...
        public ActionResult InternationalStudentWorldWideQuotation(string Data)
        {
                    ...
                    else
                    {
                        if (IMGstatus == "1")
                        {
                            ...
                            if (req.TouristISOCODE != "US")
                            {
                                ...
                                string[] productCode = { "EPSUI", "SHAI", "SHAPI" };
        ...
        public Models.RootObject Index(QuotationModel req)
        {
            ...
            AllQuatationresult.planDeductible = Convert.ToDouble(50);
        ...
        public List<Models.TrawickStudentResponnse> trawick_purchase(QuotationModel req, int ID)
        {
            ...
            try
            {
                ...
                //{
                    var FilterTrawick="";
                    finalResult = jsSerializer.Deserialize<List<Models.TrawickStudentResponnse>>(result);
                    int maxage = 0;
                    int minage = 0;
                    double premium1 = 0.0;
                    double spousepremiumamount = 0.0;
                    double childpremiumamount = 0.0;
                    double planmax = 0.0;
                    var months = 0.0;
                    var planname = "";
                    for (int i=0;i < finalResult[0].v.Count; i++)
                    {
                        if(finalResult[0].v[i].max_age >=age && finalResult[0].v[i].min_age <= age)
                        {
                            premium1 = finalResult[0].v[i].student_rate;
                            planmax = finalResult[0].v[i].policy_max;
                            planname = finalResult[0].name;
                            var days = DATE;
                            days = (days % 30);
                             months = Math.Floor(DATE / 30);
                            if (days > 0)
                            {
                                months = (months) + 1;
                            }
                            ...
                            premium1 = premium1 * months;
                            if(req.spouseage != "")
                            {
                                spousepremiumamount = finalResult[0].v[i].spouse_rate * months;
                                
                            }
                            if(req.child1age != "")
                            {
                                childpremiumamount = finalResult[0].v[i].child_rate * months;
                            }
                            if (req.child2age != "")
                            {
                                childpremiumamount = (finalResult[0].v[i].child_rate * months) + childpremiumamount;
                            }
                            if (req.child3age != "")
                            {
                                childpremiumamount = (finalResult[0].v[i].child_rate * months) + childpremiumamount;
                            ...
                            premium1 = premium1 + spousepremiumamount + childpremiumamount;
                        }
                    }
                    //var FilterTrawick = finalResult.Where(i => i >= age && i.min_age <= age).ToList();
                    ...
                    //double premiumamount = FilterTrawick[0].student_rate; 
                    double premiumamount = 0.0;
                    var premium = Math.Floor(premium1 * 100) / 100;
                    AllQuatationResult AllQuatationresult = new AllQuatationResult();
                    ...
                    AllQuatationresult.planDeductible = Convert.ToDouble(2.0);
                    AllQuatationresult.preExDeductible = 0.0;
                    AllQuatationresult.preExCoverageAmount = 0.0;
                        ...
                        if ((quote.spouseage == "") && (quote.child1age == "" && quote.child2age == "") && (quote.child3age == "" && quote.child4age == ""))
                        {
                            ...
                            foreach (Models.INF_Quote item in finalResult)
                            {
                                ...
                                if (item.policyName == "INF STANDARD" || item.policyName == "INF TRAVELUSA" || item.policyName == "INF ELITE" || item.policyName == "INF PREMIER")
                                {
                                    ...
                                    AllQuatationresult.planDeductible = Convert.ToDouble(item.planDeductible);
        ...
        public int SearchStudyusa(QuotationModel req, double DATE, int age, string plantype, string planname)
        {
            ...
            {
                planmax = 300000;
                productCode = "SUHP3I";   productCode = "SUHP3I";
            }
            ...
            if ((req.spouseage == "") && (req.child1age == "") && (req.child2age == "") && (req.child3age == "") && (req.child4age == ""))
            {
                if (plantype == "Student Only")
                {
                    ...
                    AllQuatationresult.planDeductible = Convert.ToDouble(deductibe);
                    AllQuatationresult.preExDeductible = 0.0;
                    AllQuatationresult.preExCoverageAmount = 0.0;
                    AllQuatationresult.totalPremium = premium;
                    AllQuatationresult.planMaximum = planmax + 5;
                    AllQuatationresult.INsuranceComp = "IMG";
                    AllQuatationresult.BuyNowLink = "";
                    AllQuatationresult.policyType = "";
                    AllQuatationresult.prexded = "N";
        ...
        public string SearchHCCAtlas(string policymax, string deductible, string AppName, QuotationModel req, int age)
        {
            try
            {
                ...
                else
                {
                    if (AppName == "Elite")
                    {
                        Planname = "STUDENT SECURE ELITE INTERNATIONAL";
                    }
                    else if (AppName == "Budget")
                    {
                        Planname = "STUDENT SECURE BUDGET INTERNATIONAL";
                    }
                    else if (AppName == "Select")
                    {
                        Planname = "STUDENT SECURE SELECT INTERNATIONAL";
                    }
                    else if (AppName == "Smart")
                    {
                        Planname = "STUDENT SECURE SMART INTERNATIONAL";
                    }
                }
                List<QuotationModel> listitem = quotationalmanager.GetPlanDetails(AppName);
